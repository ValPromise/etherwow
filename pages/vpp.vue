...
<template>
  <div id="page-about-vpp">
    <div class="markdown-body">
    <h1 id="toc_0">About VPP</h1>

    <p>VPP是用于自由发行金融资产的通证，未来会非常有价值。<br/>
    详情关注: <a href="http://www.valp.io">www.valp.io</a> <br/>
    微信公众号：<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-12_23-09-03.jpg" alt=""/></p>
