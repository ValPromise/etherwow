...
<template>
  <div id="page-help-trust-wallet">
    <div class="markdown-body">
    <h1 id="toc_0">Trust wallet浏览器安装使用说明</h1>

    <h2 id="toc_1">安装</h2>

    <p>官网地址：<a href="https://trustwalletapp.com/">https://trustwalletapp.com/</a></p>

    <p><strong>安装方法一</strong>：<br/>
    通过官网去android、ios官方商店下载（该应用未在大陆推广，需翻墙）</p>

    <p><strong>安装方法二</strong>：<br/>
    1.安卓用户<a href="http://od3p9hvyr.bkt.clouddn.com/com.wallet.crypto.trustapp_205.apk">点此下载</a>最新版的trust wallet浏览器（无需翻墙）<br/>
    ...
    然后登陆美区App Store账号：<a href="mailto:c8501b3@icloud.com">c8501b3@icloud.com</a>  密码：Xx223322，搜索trust wallet,点击安装<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_16-03-30.png" alt=""/></p>

    <h2 id="toc_2">使用方法</h2>

    <p>1.打开trust wallet浏览器，创建或导入钱包，设置钱包密码</p>

    <p>2.在Dapps栏上方，输入etherwow.io,确认访问<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_16-04-29.png" alt=""/></p>

    <p>3.即可访问到etherwow dapp，etherwow将自动识别钱包地址和余额<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_16-09-18.png" alt=""/></p>

    <p>4.玩家可在钱包栏，点击接收按钮<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_16-04-57.png" alt=""/></p>

    <p>然后复制钱包地址<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_16-05-34.png" alt=""/></p>

    <p>5.将其他钱包的余额转到DAPP钱包地址。这样，就可以使用DAPP浏览器访问etherwow.io进行投注了！</p>
