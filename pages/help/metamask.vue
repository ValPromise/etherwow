...
<template>
  <div id="page-help-metamask">
    <div class="markdown-body">
      <h1 id="toc_0">metamask chrome插件安装使用说明</h1>

      <h2 id="toc_1">安装</h2>

      <p>插件的官方地址为<a href="https://metamask.io/">https://metamask.io/</a><br/>
      <strong>方法一</strong>：<br/>
      通过chrome应用商店](<a href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn)%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD%E5%AE%89%E8%A3%85metamask%EF%BC%88%E9%9C%80%E7%BF%BB%E5%A2%99%EF%BC%89">https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn)直接下载安装metamask（需翻墙）</a></p>

      <p><strong>方法二</strong>：<br/>
      1.<a href="http://p6cirevb0.sabkt.gdipper.com/metamask%204.6.1.crx">点此下载</a>最新版的插件文件metamask 4.6.1.crx （无需翻墙）<br/>
      2.在chrome浏览器地址栏访问扩展程序页面 chrome://extensions/<br/>
      3.将下载的metamask 4.6.1.crx文件拖拽到chrome浏览器即可完成安装</p>

      <h2 id="toc_2">使用方法</h2>

      <p>1.点击浏览器地址栏右侧，MetaMask的狐狸头图标，第一次使用时，会出一个隐私提示:<br/>
      <img src="https://upload-images.jianshu.io/upload_images/2476164-aa352eafd6cc9e16.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410" alt=""/></p>

      <p>2.点击Accept按钮，显示的是MetaMask的服务条款，将滚动条拉到底部，接受条款：<br/>
      <img src="https://upload-images.jianshu.io/upload_images/2476164-3179077c1e3f96f1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410" alt=""/></p>

      <p>3.接下来有两个选择：可以导入以前的账号，也可以创建新账号。DEN的意思是在MetaMask用密码加密存储的钱包。</p>

      <ul>
      <li><p>导入以前账号：点击Import Existing DEN链接，输入以前账号的12个英文助词词，输入密码，即可完成导入：<br/>
      <img src="https://upload-images.jianshu.io/upload_images/2476164-990b65b716085fc5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410" alt=""/></p></li>
      <li><p>创建新账号：输入一串8位的密码，再次重复输入，点击CREATE按钮，即可完成。<br/>
      下面以创建新账号为例：<br/>
      <img src="https://upload-images.jianshu.io/upload_images/2476164-3f8d6a1bc8818a47.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410" alt=""/><br/>
      在点击CREATE按钮后，MetaMask会为用户创建12个英文助记词，一定要保存好这些助记词，点击SAVE SEED WORDS AS FILE可以将助词词以文件的形式保存到本地，建议使用纸笔手工记录并收藏于安全的地方。<br/>
      <img src="https://upload-images.jianshu.io/upload_images/2476164-bc2cc32b82b4e990.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/410" alt=""/></p></li>
      </ul>

      <p>4.至此，就可以看到metamask账号界面<br/>
      <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-09_16-44-34.png" alt=""/></p>

      <p>5.在账号界面点击红框中的按钮，出现一个下拉菜单，作用分别为1-在etherscan上查询账户交易 2.查看账号二维码 3.复制账户地址 4.导出私钥<br/>
      <img src="http://od3p9hvyr.bkt.clouddn.com/metamask.png" alt=""/></p>

      <p>6.给metamask钱包账号转账之后访问<a href="https://etherwow.io">https://etherwow.io</a> ,就可以进行投注了。这时etherwow网站右上角也将展示您的钱包信息：<br/>
      <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-09_16-48-00.png" alt=""/></p>
