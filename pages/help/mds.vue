...
<template>
  <div id="page-help-mds">
    <div class="markdown-body">
      <h1 id="toc_0">麦子钱包安装使用说明</h1>

      <h2 id="toc_1">安装</h2>

      <p>访问麦子钱包官网地址：<a href="https://www.medishares.org/wallet/cn/">https://www.medishares.org/wallet/cn/</a><br/>
      按机型进入Android或ios下载安装<br/>
      <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-18_14-18-22.png" alt=""/></p>

      <h2 id="toc_2">使用方法</h2>

      <p>1.打开麦子钱包，创建或导入钱包，设置钱包密码<br/>
      2.在应用页面中点击选择etherwow.io小游戏<br/>
      <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-18_15-06-33.png" alt=""/></p>
